...
public class RegistroRestController {
	...
	@PutMapping
	public Optional<Registro> registrarSalida(@RequestParam("placa") String placa) {
		Optional<Vehiculo> vehiculo = getCarroService().getVehiculo(placa);
		return getVigilanteService().registrarSalida(vehiculo.orElse(null));
	}

	@GetMapping
	public List<Registro> getRegistros() {
		return getVigilanteService().getRegistrosPendientes();
	}
}
